...
@class MLKITx_FBMLAggregatedOnDeviceImageLabelDetectionLogEvent_LogEventKey, MLKITx_FBMLDurationStats;

@interface MLKITx_FBMLAggregatedOnDeviceImageLabelDetectionLogEvent : GPBMessage
{
}
...
@property(retain, nonatomic) MLKITx_FBMLAggregatedOnDeviceImageLabelDetectionLogEvent_LogEventKey *logEventKey; // @dynamic logEventKey;
