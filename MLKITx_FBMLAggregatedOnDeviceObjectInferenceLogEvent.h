...
@class MLKITx_FBMLAggregatedOnDeviceObjectInferenceLogEvent_LogEventKey, MLKITx_FBMLDurationStats;

@interface MLKITx_FBMLAggregatedOnDeviceObjectInferenceLogEvent : GPBMessage
{
}
...
@property(retain, nonatomic) MLKITx_FBMLAggregatedOnDeviceObjectInferenceLogEvent_LogEventKey *logEventKey; // @dynamic logEventKey;
