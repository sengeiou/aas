...
@class MLKITx_CCTClearcutCounters, NSObject<OS_dispatch_queue>;

@interface MLKITx_CCTClearcutAutoCounters : NSObject
{
...
@property(readonly, nonatomic) MLKITx_CCTClearcutCounters *counters; // @synthesize counters=_counters;
