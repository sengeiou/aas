...
@class MLKITx_FBMLImageInfo, MLKITx_FBMLOnDeviceImageLabelOptions;

@interface MLKITx_FBMLAggregatedOnDeviceImageLabelDetectionLogEvent_LogEventKey : GPBMessage
{
}
