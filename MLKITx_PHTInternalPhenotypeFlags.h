...
#import "PHTBasePhenotypeFlagsProtocol.h"

@class MLKITx_PHTPhenotypeExperimentTokens, MLKITx_PHTPhenotypeFlagsSnapshot, NSCondition, NSObject<OS_dispatch_queue>, NSString;

@interface MLKITx_PHTInternalPhenotypeFlags : NSObject <PHTBasePhenotypeFlagsProtocol>
{
    ...
    MLKITx_PHTPhenotypeFlagsSnapshot *_atomicSnapshot;
}
...
+ (id)sharedInstance;
@property(retain) MLKITx_PHTPhenotypeFlagsSnapshot *atomicSnapshot; // @synthesize atomicSnapshot=_atomicSnapshot;
