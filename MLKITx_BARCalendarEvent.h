...
@class MLKITx_BARCalendarDateTime, NSString;

@interface MLKITx_BARCalendarEvent : GPBMessage
{
}
...
@property(retain, nonatomic) MLKITx_BARCalendarDateTime *end; // @dynamic end;
...
@property(retain, nonatomic) MLKITx_BARCalendarDateTime *start; // @dynamic start;
