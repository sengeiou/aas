...
#import "MLKITx_CCTClearcutLogger.h"

@class MLKITx_GIPPseudonymousIDStore, NSArray, NSString, NSURL;

@interface MLKITx_CCTClearcutLogger : NSObject <MLKITx_CCTClearcutLogger>
{
    _Bool _isAnonymous;
    int _qosTier;
