...
@class NSArray, NSData, NSObject<PHTCommitObserver>, NSString;

@protocol MLKITx_PHTPhenotype <NSObject>
...
- (void)committedConfiguration:(NSString *)arg1 callback:(void (^)(MLKITx_PHTPhenotypeConfiguration *, NSError *))arg2;
- (void)committedConfiguration:(NSString *)arg1 user:(NSString *)arg2 callback:(void (^)(MLKITx_PHTPhenotypeConfiguration *, NSError *))arg3;
- (void)experimentTokensForCurrentBundleWithCallback:(void (^)(MLKITx_PHTPhenotypeExperimentTokens *, NSError *))arg1;
- (void)experimentTokens:(long long)arg1 user:(NSString *)arg2 callback:(void (^)(MLKITx_PHTPhenotypeExperimentTokens *, NSError *))arg3;
- (void)commitConfiguration:(NSString *)arg1 user:(NSString *)arg2 committer:(_Bool (^)(MLKITx_PHTPhenotypeConfiguration *, NSError *))arg3;
