...
@class MLKITx_CCTClientInfoMaker, NSConditionLock, NSMutableDictionary, NSObject<OS_dispatch_queue>;

@interface MLKITx_CCTLogWriter : NSObject
{
    ...
    MLKITx_CCTClientInfoMaker *_clientInfoMaker;
...
@property(readonly, nonatomic) MLKITx_CCTClientInfoMaker *clientInfoMaker; // @synthesize clientInfoMaker=_clientInfoMaker;
