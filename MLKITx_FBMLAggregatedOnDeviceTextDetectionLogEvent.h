...
@class MLKITx_FBMLAggregatedOnDeviceTextDetectionLogEvent_LogEventKey, MLKITx_FBMLDurationStats;

@interface MLKITx_FBMLAggregatedOnDeviceTextDetectionLogEvent : GPBMessage
{
}
...
@property(retain, nonatomic) MLKITx_FBMLAggregatedOnDeviceTextDetectionLogEvent_LogEventKey *logEventKey; // @dynamic logEventKey;
