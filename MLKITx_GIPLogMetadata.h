...
@class MLKITx_GIPLogCallstack, NSDictionary, NSError, NSString;

@interface MLKITx_GIPLogMetadata : NSObject <NSCopying>
{
...
@property(readonly, nonatomic) MLKITx_GIPLogCallstack *callstack;
