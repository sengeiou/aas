...
@class GPBInt32Array, GPBMessage, MLKITx_NetworkConnectionInfo, NSArray, NSData, NSMutableArray, NSString;

@interface MLKITx_CCTClearcutLogEvent : NSObject <NSCopying>
{
    ...
    MLKITx_NetworkConnectionInfo *_networkConnectionInfo;
    NSString *_testID;
...
@property(copy, nonatomic) MLKITx_NetworkConnectionInfo *networkConnectionInfo; // @synthesize networkConnectionInfo=_networkConnectionInfo;
