...
@class MLKITx_PHTPhenotypeFlags, NSMutableDictionary, NSString;

@interface MLKITx_CCTClearcutFlags : NSObject
{
...
- (void)update;
@property(readonly) MLKITx_PHTPhenotypeFlags *allFlags;
