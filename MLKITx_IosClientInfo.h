...
@class MLKITx_IosAccessibilityState, NSString;

@interface MLKITx_IosClientInfo : GPBMessage
{
}
...
@property(retain, nonatomic) MLKITx_IosAccessibilityState *accessibilityState; // @dynamic accessibilityState;
