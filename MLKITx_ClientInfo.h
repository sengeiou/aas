...
@class MLKITx_DesktopClientInfo, MLKITx_IosClientInfo, NSString;

@interface MLKITx_ClientInfo : GPBMessage
{
}
...
@property(retain, nonatomic) MLKITx_DesktopClientInfo *desktopClientInfo; // @dynamic desktopClientInfo;
...
@property(retain, nonatomic) MLKITx_IosClientInfo *iosClientInfo; // @dynamic iosClientInfo;
