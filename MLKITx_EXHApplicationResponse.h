...
@class GPBInt32Array, MLKITx_EXHConfigurationTier, MLKITx_EXHScope, NSData, NSMutableArray, NSString;

@interface MLKITx_EXHApplicationResponse : GPBMessage
{
}
...
@property(retain, nonatomic) MLKITx_EXHConfigurationTier *configTier; // @dynamic configTier;
