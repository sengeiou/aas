...
@class MLKITx_FBMLAggregatedOnDeviceFaceDetectionLogEvent_LogEventKey, MLKITx_FBMLDurationStats;

@interface MLKITx_FBMLAggregatedOnDeviceFaceDetectionLogEvent : GPBMessage
{
}
...
@property(retain, nonatomic) MLKITx_FBMLAggregatedOnDeviceFaceDetectionLogEvent_LogEventKey *logEventKey; // @dynamic logEventKey;
