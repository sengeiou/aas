...
#import "PHTPhenotypeFlagsProtocol.h"

@class MLKITx_PHTPhenotypeExperimentTokens, MLKITx_PHTPhenotypeFlagsSnapshot, NSCondition, NSHashTable, NSString;

@interface MLKITx_PHTPhenotypeFlags : NSObject <PHTPhenotypeFlagsProtocol>
{
