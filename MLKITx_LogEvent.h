...
@class GPBInt32Array, MLKITx_EXHExperimentIds, MLKITx_NetworkConnectionInfo, NSData, NSString;

@interface MLKITx_LogEvent : GPBMessage
{
}
...
@property(retain, nonatomic) MLKITx_EXHExperimentIds *experimentIds; // @dynamic experimentIds;
...
@property(retain, nonatomic) MLKITx_NetworkConnectionInfo *networkConnectionInfo; // @dynamic networkConnectionInfo;
