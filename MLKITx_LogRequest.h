...
@class MLKITx_ClientInfo, MLKITx_CollectForDebug, NSMutableArray, NSString;

@interface MLKITx_LogRequest : GPBMessage
{
}
...
@property(retain, nonatomic) MLKITx_CollectForDebug *collectForDebug; // @dynamic collectForDebug;
